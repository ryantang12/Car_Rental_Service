...
def init_db():
    ...
    sample_cars = [
    ('Toyota', 'Camry', 2022, 25.0, True, 'https://www.cstatic-images.com/car-pictures/xl/USC60TOC021B021001.png', 'Sedan'),
    ('BMW', 'M4', 2025, 25.0, True, 'https://www.cstatic-images.com/car-pictures/xl/USC90BMC041A021001.png', 'Sports'),
    ('Honda', 'Civic', 2021, 22.0, True, 'https://www.cstatic-images.com/car-pictures/xl/USC00HOC021A021001.png', 'Sedan'),
    ('Ford', 'Mustang', 2023, 45.0, True, 'https://www.cstatic-images.com/car-pictures/xl/USR30FOC021B021001.png', 'Sports'),
    ('BMW', 'X5', 2022, 55.0, True, 'https://www.cstatic-images.com/car-pictures/xl/USC80BMC451A021001.png', 'SUV'),
    ('Tesla', 'Model 3', 2023, 35.0, True, 'https://www.cstatic-images.com/car-pictures/xl/USR60TSC041B021001.png', 'Electric'),
    ('Nissan', 'Altima', 2021, 24.0, True, 'https://www.cstatic-images.com/car-pictures/xl/USC10NIC021C021001.png', 'Sedan'),
    ('Jeep', 'Wrangler', 2023, 40.0, True, 'https://www.cstatic-images.com/car-pictures/xl/USR20JPC201B021001.png', 'SUV'),
    ('Mercedes', 'C-Class', 2022, 50.0, True, 'https://www.cstatic-images.com/car-pictures/xl/USC90MBC021A021001.png', 'Luxury')
]
